<template>
  <view class="t-order-item">
    ...
    <div class="op-content">
      <nut-button size="mini" type="default" @click="changeState()"
        >修改状态</nut-button
      >
      <nut-button size="mini" type="default" @click="handlePrint()"
        >设置打印机</nut-button
      >
      <nut-button size="mini" type="default" @click="handlePrint(orderDetail)"
        >打印</nut-button
      >
    </div>
  </view>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    return { handlePrint, goUrl, getSkuPic, getSkuName, statusObj, changeState };
  },
};
</script>
<style lang="less">
